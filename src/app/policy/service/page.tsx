  ...
  return (
    <div className={styles.container}>
      ...
      <article>
        ...
        <Paragraph>
          {
            "이 약관은 Pixxel Game (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다."
          }
        </Paragraph>
        <Paragraph> </Paragraph>
        ...
        <ArticleTitle>제3조(약관 외 준칙)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제4조(약관의 효력과 변경)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
            {
              "이 약관은 Pixxel Game(이)가 제공하는 모든 인터넷서비스에 게시하여 공시합니다. '회사'는 ‘전자상거래 등에서의 소비자보호에 관한 법률(이하 '전자상거래법'이라 함)', '약관의 규제에 관한 법률(이하 '약관규제법'이라 함)', '전자문서 및 전자거래 기본법(이하 '전자문서법'이라 함)', ‘전자금융거래법 ‘, '정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법'이라 함)', '소비자기본법' 등 관계 법령(이하 '관계법령' 이라 함)에 위배되지 않는 범위 내에서 이 약관을 변경할 수 있으며, 회사는 약관이 변경되는 경우에 변경된 약관의 내용과 시행일을 정하여, 그 시행일로부터 최소 7일 (이용자에게 불리하거나 중대한 사항의 변경은 30일) 이전부터 시행일 후 상당한 기간 동안 공지하고, 기존 이용자에게는 변경된 약관, 적용일자 및 변경사유(변경될 내용 중 중요사항에 대한 설명을 포함)를 별도의 전자적 수단(전자우편, 문자메시지, 서비스 내 전자쪽지발송, 알림 메시지를 띄우는 등의 방법)으로 개별 통지합니다. 변경된 약관은 공지하거나 통지한 시행일로부터 효력이 발생합니다."
            }
          </OrderedList.Item>
          <OrderedList.Item>
            {
        ...
        <ArticleTitle>제5조(이용자에 대한 통지)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제6조(이용계약의 체결)</ArticleTitle>
        ...
        <ArticleTitle>제7조(회원가입에 대한 승낙)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제8조(회원정보의 변경)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제9조(회원정보의 관리 및 보호)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제10조(회사의 의무)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제11조(개인정보보호)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제12조(이용자의 의무)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제13조(서비스의 제공)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
          ...
          <OrderedList.Item>
            ...
            <OrderedList.Root>
              <OrderedList.Item>
                웹페이지에서 수집된 게임 가격을 비교하는 서비스
              </OrderedList.Item>
              <OrderedList.Item>
                회원 및 맞춤 정보를 통한 알림 서비스
              </OrderedList.Item>
              <OrderedList.Item>
                기타 게임과 관련된 편의를 제공하는 서비스
              </OrderedList.Item>
            </OrderedList.Root>
          </OrderedList.Item>
        </OrderedList.Root>
        ...
        <ArticleTitle>제14조(서비스의 제한 등)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제15조(서비스의 해제·해지 및 탈퇴 절차)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제16조(손해배상)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제17조(면책사항)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제18조(정보의 제공 및 광고의 게재)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제19조(권리의 귀속)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제20조(콘텐츠의 관리)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
            {
        ...
        <ArticleTitle>제21조(콘텐츠의 저작권)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
          ...
          <OrderedList.Item>
            ...
            합치되는 범위 내에서 다음 각 호와 같이 회원이 등록한 콘텐츠를 사용할
            수 있습니다.
            <OrderedList.Root>
              <OrderedList.Item>
                서비스 내에서 이용자가 작성한 콘텐츠의 복제, 수정, 전시, 전송,
                배포 등 저작권을 침해하지 않는 범위 내의 2차적저작물 또는 편집
                저작물 작성을 위한 사용. 다만, 해당 콘텐츠를 등록한 이용자가
                해당 콘텐츠의 삭제 또는 사용 중지를 요청하는 경우 회사는 관련
                법에 따라 보존해야하는 사항을 제외하고 관련 콘텐츠를 모두 삭제
                또는 사용중지합니다.
              </OrderedList.Item>
              <OrderedList.Item>
        ...
        <ArticleTitle>제22조(관할법원 및 준거법)</ArticleTitle>
        <Paragraph>
        ...
        <Paragraph>제1조 본 약관은 2024.09.12.부터 시행됩니다.</Paragraph>
      </article>
    </div>
  );
}
