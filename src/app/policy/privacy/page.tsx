  ...
  return (
    <div className={styles.container}>
      ...
      <article>
        ...
        <Paragraph>
          {
            "Pixxel Game(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다."
          }
        </Paragraph>
        <Paragraph> </Paragraph>

        <ArticleTitle>제2조(개인정보 처리의 원칙)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제3조(본 방침의 공개)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제4조(본 방침의 변경)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제5조(회원 가입을 위한 정보)</ArticleTitle>
        <Paragraph>
        ...
        <OrderedList.Root>
          <OrderedList.Item>
            필수 수집 정보: 로그인 SNS 식별자, 이메일, 이름, 프로필 이미지
          </OrderedList.Item>
        </OrderedList.Root>
        <Paragraph> </Paragraph>

        <ArticleTitle>제6조(기타 수집 정보)</ArticleTitle>
        <Paragraph>회사는 아래와 같이 정보를 수집합니다.</Paragraph>
        <OrderedList.Root>
          <OrderedList.Item>
            수집목적: 서비스 이용 현황 분석, 성능 데이터 및 오류 데이터 수집 및
            분석
          </OrderedList.Item>
          <OrderedList.Item>
            수집정보: 브라우저 정보, OS 정보, 서비스 사용 기록
          </OrderedList.Item>
        </OrderedList.Root>
        <Paragraph> </Paragraph>

        <ArticleTitle>제7조(개인정보 수집 방법)</ArticleTitle>
        <Paragraph>
        ...
        <OrderedList.Root>
          ...
          <OrderedList.Item>
            서비스 이용과정에서 자동으로 수집하는 방식
          </OrderedList.Item>
        </OrderedList.Root>
        <Paragraph> </Paragraph>

        <ArticleTitle>제8조(개인정보의 이용)</ArticleTitle>
        <Paragraph>회사는 개인정보를 다음 각 호의 경우에 이용합니다.</Paragraph>
        <OrderedList.Root>
          <OrderedList.Item>
          ...
          <OrderedList.Item>신규 서비스 개발을 위한 경우</OrderedList.Item>
        </OrderedList.Root>
        <Paragraph> </Paragraph>

        <ArticleTitle>제9조(개인정보의 처리 위탁)</ArticleTitle>
        <Paragraph>
        ...
        <OrderedList.Root>
          <OrderedList.Item>
            Supabase에게 회원가입, 이용자 식별, 서비스 이용를 위하여 회원 탈퇴
            또는 위탁 종료시동안 개인정보처리를 위탁함
          </OrderedList.Item>
          <OrderedList.Item>
            Sentry에게 서비스 성능 및 오류 데이터 수집 및 분석를 위하여 브라우저
            정보, OS 정보 개인정보처리를 위탁함
          </OrderedList.Item>
        </OrderedList.Root>
        <Paragraph> </Paragraph>

        <ArticleTitle>제10조(개인정보의 보유 및 이용기간)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <OrderedList.Root>
          <OrderedList.Item>
            ...
            <OrderedList.Root>
              ...
              <OrderedList.Item>표시•광고에 관한 기록 : 6개월</OrderedList.Item>
            </OrderedList.Root>
          </OrderedList.Item>
          <OrderedList.Item>
        ...
        <ArticleTitle>제12조(개인정보의 파기원칙)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제13조(개인정보파기절차)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제14조(개인정보파기방법)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제15조(광고성 정보의 전송 조치)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
          ...
          <OrderedList.Item>
            ...
            <OrderedList.Root>
              <OrderedList.Item>회사명 및 연락처</OrderedList.Item>
              <OrderedList.Item>
        ...
        <ArticleTitle>제16조(개인정보 조회 및 수집동의 철회)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제17조(개인정보 정보변경 등)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제18조(이용자의 의무)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제19조(회사의 개인정보 관리)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제20조(삭제된 정보의 처리)</ArticleTitle>
        <Paragraph>
          {
        ...
        <ArticleTitle>제21조(비밀번호의 암호화)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제22조(해킹 등에 대비한 대책)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <ArticleTitle>제23조(개인정보 처리 최소화 및 교육)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제24조(개인정보 유출 등에 대한 조치)</ArticleTitle>
        <Paragraph>
          {
        ...
        <OrderedList.Root>
          <OrderedList.Item>유출 등이 된 개인정보 항목</OrderedList.Item>
          <OrderedList.Item>유출 등이 발생한 시점</OrderedList.Item>
          <OrderedList.Item>이용자가 취할 수 있는 조치</OrderedList.Item>
          <OrderedList.Item>
        ...
        <ArticleTitle>제25조(개인정보 유출 등에 대한 조치의 예외)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제26조(국외 이전 개인정보의 보호)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
          ...
          <OrderedList.Item>
            ...
            모두를 이용자에게 고지합니다.
            <OrderedList.Root>
              <OrderedList.Item>이전되는 개인정보 항목</OrderedList.Item>
              <OrderedList.Item>
        ...
        <ArticleTitle>제28조(쿠키 설치 허용 지정 방법)</ArticleTitle>
        <Paragraph>
        ...
        <ArticleTitle>제29조(회사의 개인정보 보호 책임자 지정)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
            ...
            <OrderedList.Root>
              <OrderedList.Item>
                개인정보 보호 책임자
                <OrderedList.Root>
                  <OrderedList.Item>성명: 김진관</OrderedList.Item>
                  <OrderedList.Item>
                    이메일: pixxelgame.dev@gmail.com
                  </OrderedList.Item>
                </OrderedList.Root>
              </OrderedList.Item>
            </OrderedList.Root>
        ...
        <ArticleTitle>제30조(권익침해에 대한 구제방법)</ArticleTitle>
        <OrderedList.Root>
          <OrderedList.Item>
        ...
        <Paragraph>제1조 본 방침은 2024.09.12.부터 시행됩니다.</Paragraph>
      </article>
    </div>
  );
}
