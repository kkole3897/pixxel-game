  ...
  return (
    <Link href={href} target="_blank" className={styles.storeLink}>
      ...
      <div className={styles.priceArea}>
        {isDiscounted && <div className={styles.initialPriceArea}>
        ...
        {!isLowest && <div className={styles.lowestPriceArea}>
          <span>스토어 최저가: <span className={styles.lowestPrice}>{lowestPriceText}</span></span>
        </div>}
      </div>
    </Link>
  );
