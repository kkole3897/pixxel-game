...
export default function RecommendPercent({ percent, tier }: { percent: number; tier: OpenCriticTier }) {
  ...
  return (
    <div className={styles.container}>
      ...
      <svg viewBox='0 0 32 32' width={38} height={38} className={styles.radial} style={assignInlineVars({ [styles.radialTransform]: transform })}>
          <defs>
          ...
          <circle r="16" cx="16" cy="16" stroke="#2e2e2e" strokeWidth="32" fill={`url(#${gradientId})`} className={styles.circle} style={assignInlineVars({ [styles.circleDashArray]: dashArray})}></circle>
        </svg>
